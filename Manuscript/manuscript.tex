...
too quickly.  Table~\ref{USAvsWorld} below highlights the difference in reaction times for
...
The R package \citet{lme4} allows various linear mixed effects models to be
created, and was the primary modeling package used for our data analysis.
