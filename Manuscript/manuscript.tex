...
0.123 and 0.101 in his preliminary heat and semifinal, respectively.  The
reaction time barrier for all sprint related events is 0.1 seconds as set by the
International Association of Athletics Federation (IAAF) and is meant
to prevent athletes from trying to predict the starting gun.
His disqualification in the final heat by reacting in 0.099 seconds, just 0.001
seconds faster than the 0.1 threshold, was met
...
The first objective of this paper is to determine whether there were 
abnormalities with athlete's reaction times at the 2022 World Track and Field
Championship.  Our analysis consists of quantitatively comparing reaction times for athletes who 
have competed at additional competitions to the 2022 World Track and Field 
Championship (Similar to a matched pairs design). By comparing reaction times from the same athlete across multiple
competitions we are able to determine if the 2022 reaction times differed 
significantly from those of other competitions.  This investigation, while
motivated by Allen's disqualifcation has wider impacts across track and field
that question if there is more variation than previously thought in track and
field timing equipment. 

The second objective of this paper is to analyze whether the current
reaction time barrier of 0.1 seconds is fair, and in this regard there have been
many publications debating the human capacity for reaction times 
\of{This sounds funny but I'm not sure how to fix it}.
...
These papers support increasing the reaction time barrier as they determined
that athletes are better than how IAAF thinks they are. Unfortunately, IAAF has
not changed the reaction barrier since it was
implemented at the 1999 World Track and Field Championships.
Additionally, \citet{komi2009iaaf} recommended that high speed cameras be used to
...
However, not all studies have been in favor of a decrease in the
...
react in as little as 0.1 seconds \citep{lipps2011implications}. However it is
worth noting that \citet*{brosnan2017effects} and \citep{lipps2011implications}
were retroactive studies of athletes at events while \citet{pain2007sprint} and
\citet{komi2009iaaf} were experiments showing that there are various methods
of testing reaction time capability.


The second part of this paper will model the reaction times of every non-disqualification since the 1999 World 
