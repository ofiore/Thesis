...
\begin{table}
  ...
  \begin{tabular}{c c c c c} 
   ...
   2022 National vs International Men & $<0.001$ & $ 6.1 \cdot 10^{-5}$ & 17 & 80 \\
   2022 National vs International Women & $<0.001$ & $ 1.2 \cdot 10^{-3}$ & 17 & 80 \\
...
\end{table}
\of{Table currently doesnt fit on the page but can be fixed by abbreviating some
of the names in the comparison column.  I used <0.001 becuase that is what we
