...
Additional results are summarized in a supplement for rank-based
comparison with pooled (men and women) data and for the GAMLSS results
for women data.
