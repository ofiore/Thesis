...
The p value associated with the two group comparison for 2019 and 2022 was 0.001464.  
\eds{what is the ds method?} \of{Its described in the methods section but I dont
think its no longer needed now that we are no longer using the other grouping
method (I believe it was called something like the rosner method)}
...
tracking reaction time as an official measurement until 1999 in the men's 110 meter
hurdles and women's 100 meter hurdles. 
