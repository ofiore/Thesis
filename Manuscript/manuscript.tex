...
$0.028$, which is significant at $\alpha = 0.05$. 
...
Both plots agree to some extent with the pattern of the box plots in
...
\of{I believe Prof Yan wrote that. I would write that sentence as "The mismatch
is due to the heat effect, as venue effect only captures a part of the patterns
in the data" or something of that nature.}
