...
\of{Does it make sense to order the table how I did, and block by dataset or
should I block by model?}
\begin{table}
  \centering
  ...
  \begin{tabular}{c c c c c c}
      ...
      \midrule
      With 2022 Venue Effect Only & $-2023.5$ &   & 0.054 & $-1.871$ & 0.150\\
      With 2022 Heat Effect Only & $-2070.7$ & 0.073 &  & $-1.890$ & 0.135\\
      With 2022 Venue and Heat Effect & $-2075.7$ & 0.057 & 0.040 & $-1.880$ & 0.134\\
      \midrule
      Without 2022 Venue Effect Only & $-1862.2$ &   & 0.048 & $-1.857$ & 0.152\\
      Without 2022 Heat Effect Only & $-1910.9$ & 0.069 &  & $-1.877$ & 0.136\\
      Without 2022 Venue and Heat Effect & $-1912.9$ & 0.058 & 0.033 & $-1.880$ & 0.136\\
      \bottomrule
  \end{tabular}
\end{table}

\jy{Hopefully, the full model is preferred for both with and without 2022}
\of{It is but the AIC are more similar without 2022}
...
$\sigma_v$, decreases from 0.40 to 0.33 when 2022 is excluded.  Thus, 2022
increased the noise in the overall data, but many of the other statistics
remained relatively similar, such as the standard deviation of the heat effect
and the dispersion parameter.

%\of{Can I just refer to it as the dispersion parameter or should I say "square
%root of the dispersion parameter" Mathematically it shouldn't make a difference 
%right as 0.134^2 and 0.136^2 are very similar and I am applying a function to 
%both? Also should I be saying "standard deviation of heat effect", or sigma_v 
%or both?} 
...
effect, but may not be as extreme as one would think considering the history
of reaction times going back to 1999.
