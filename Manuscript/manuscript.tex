...
\of{Actually Resolved}
The GLMM with both venue and heat random effects was the best model as evidenced
by a decrease in the AIC compared to the other models with only one random effect. 
...
effect, confirming that 2022 was a low outlier.  Two aims of this section are to
...
2022 could alter the results. Using the gamma function with \texttt{link = log},
...
simulation size of $10,000,000$ was chosen to estimate the probability of 
...
\of{I think we should be good now, let me know if there is anything else}
