...
\jy{I added a sentence to the end of intro.}
...
distribution of the test statistic.  \jy{increase 1000 to a much bigger number,
  say 10 million}
...
\jy{Note that, as used in the code, we should have
  \texttt{sigma(model) \^ 2 =  phi}. So in Table 2, we can report phi in the last column.}
...
\begin{table}
  ...
  \begin{tabular}{c c c c c} 
   ...
   \midrule
   2019 vs 2022 & $2.8\cdot10^{-2}$ & $2.9\cdot10^{-3}$ \\
   2022 vs 2023 & $1.1\cdot10^{-2}$ & $3.1\cdot10^{-3}$ \\
   2022 National vs International & $2\cdot10^{-6}$ & $1.1\cdot10^{-3}$ \\
   \bottomrule
  \end{tabular}
...
\eds{Prof. Yan, is this possible based on 1000 permutations?}
\jy{That cannot be true.  Redo with a much bigger number of permutations and
  update the table.}
\of{Done, permutation results were for B = 1 million}
This
...
The GLMM with both venue and heat random
effects was the best model as evidenced by a decrease in the AIC compared to the
other models with only one random effect. 
Thus, results from the GLMM with both venue and heat random effects
...
\begin{table}
  ...
  is short for standard error. 
	\eds{This table is not showing what you have described here or in the
          main text.}
        \jy{report $ a = 1 / \phi$}
      } 
  \begin{tabular}{c c c c c c}
      \toprule
      Dataset & AIC & $\sigma_h^2$ & $\sigma_v^2$ & $\alpha$ & $1 / \phi$ \\
      \midrule
