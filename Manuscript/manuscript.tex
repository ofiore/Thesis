...
(GLMM) model that is further developed in Section~\ref{sec:glmm}. The 
...
from every world championship from 1999 to 2023. This paper was started shortly
after the 2022 World Championships, but as the 2023 data has become available 
recently, we are pleased to include it in both of our analyses, and it did not
...
competitions. Table~\ref{tab:Clusrankresults} shows multiple significant p values
that indicate differences in average reaction times for athletes who competed at
the 2022 World Track and Field Championship and another competition.  Taken
together, the results show that 2022 was an outlier and despite being disqualified,
Allen's time was not so extreme.
