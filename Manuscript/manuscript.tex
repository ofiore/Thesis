...
competition progresses \citep[e.g.,][]{zhang2021correlation}. % Athletes react 
...
%Thus, a baseline is able to be established for the four USA athletes who 
...
Table 2 summarizes the results from the gamma model from different data sets
