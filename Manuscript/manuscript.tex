...
spared waiting until the next World Track and Field Championship.
...
The alleged 99.95\% chance Allen was wronged \eds{can we use different word 
instead of wrong?  at fault?  However, should that be 0.05\% chance at fault?}
\of{Changed to "wronged"}
came from Johnson claiming there is a $(1/13)^3$ that the fastest reaction
times came during the same championship for the men's 100 meter,
men's 110 meter hurdle, and women's 100 meter for 13 competitions held between 2003 and 
2022 \eds{?} \of{Cleaned up but may need additional work}
...
\of{I think capitalization should be all set: all are in form of ``Section i''}
...
and covers the men's 110 meter hurdles from 1999 to 2022; and can be found in
the Appendix~\ref{sec:Appendix}.   \eds{see earlier comment - 
are you using any of these as covariates?}
\of{removed covariate confusion, talk about womens a couple sentences down} 
We chose not to include women's data in this
...
competition progresses \citep[e.g.,][]{zhang2021correlation}. The variable 
...
years there are very few finals observations.  For example, in 2022 there
...
\citet{brosnan2017effects} found median reaction times of 0.156 seconds \eds{mean?  median?} 
\of{Resolved}
...
false starts by two thirds \eds{for men, not overall} \of{Better?} in 2011 (6 male and 4 female disqualifications) 
...
\of{Yes you are correct, I updated the language.}
...
exploratory \eds{exploratory instead of qualitative?} \of{I agree; fixed}
...
Field Championship compared to the United States Track and Field Championship as were his
...
else (substantially?)} \of{Replaced signficantly with substantially}
...
As for the random effect, it was possible to include a heat 
...
under this category) \citep{wa2013backtage} \eds{110 for men?} \of{Fixed}. Since 1999, the
...
The United States Track and Field Championships data is available at: 
