...
%1)
Devon Allen, \eds{a student (or an alumnus)?} of the University of Oregon in 
Eugene, Oregon, was
...
if only one heat, change to singular form} and 0.101 in the semifinal.  
...
reaction times at the 2022 World Track and Field Championship 
\citep{johnson2022devon}.
...
The second method is to compare reaction times for athletes who have competed
at additional competitions to the 2022 World Track and Field Championship. 
...
(GLMM) model that is further developed in the Section~\ref{sec:Methods}. The 
