...
competitions, commissioned a study into changing the reaction time barrier \citep{reference?}.
...
that athletes can react in as low as 0.08 seconds.   \citet{pain2007sprint} looked at
...
muscular tightening conditions. Another study commissioned
\jy{Is this the same study at the beginning of this paragraph?}
...
The data can be found in the appendix~\ref{sec:Appendix} 
...
informative \citep{jiang2017wilcoxon}. \jy{explain. More data means faster
  reaction time?}
We do not care that some
...
As Seiko timed both events, there should not be a signficant
