...
started before the 2023 World Championships, but as that data has become
available recently, we are pleased to include it in our analysis.
...
athletes are on the starting blocks before the sun goes off.  Thus, we can try
to reduce this variability by accounting for this in the model through the batch
effect.
...
effect increases when
including 2022.  The two effect model with venue
...
AIC.  For the entire data, the AIC for the venue effect only model was
...
\begin{table}
  ...
  \begin{tabular}{c c c c c c}
      ...
      \midrule
      Excluding 2022 & $-1912.9$ &  0.058 & 0.033 & $-1.868$ & 0.136 \\
      All Data & $-2075.7$ & 0.057 & 0.040 & $-1.880$ & 0.134 \\
      \bottomrule
  \end{tabular}
...
of $4.38\cdot10^{-3}$ corresponds to roughly 1 in every 228 starts
being below 0.1 seconds.  When we exclude 2022, the probability of observing a
reaction time below 0.1 seconds decreased to $3.52\cdot10^{-3}$, or 1 in every
285 starts.
...
\begin{table}
  ...
  \begin{tabular}{c c c c} 
   ...
   \midrule
   Excluding 2022 & $3.19\cdot10^{-5}$ & $4.48\cdot10^{-4}$ &  $3.52\cdot10^{-3}$  \\ 
   Including 2022 & $4.01\cdot10^{-5}$ & $5.82\cdot10^{-4}$ & $4.38\cdot10^{-3}$ \\
   \bottomrule
  \end{tabular}
...
\begin{table}
  ...
  \begin{tabular}{c c c} 
   ...
   \midrule
   Old Pooled & $0.093$ & $0.084$ \\ 
   All Pooled & $0.092$ & $0.083$ \\
   \bottomrule
  \end{tabular}
  \label{tab:Sim_time}
\end{table}
