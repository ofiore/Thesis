...
at other races, and is the 0.1-second reaction time barrier fair?
...
meets. Ideally, a centralized database containing reaction times from
all World Athletics-certified meets would have allowed for a more
comprehensive analysis. Currently, however, reaction times are seldom
...
reveal that the 0.1-second reaction time barrier, while rare, may not
