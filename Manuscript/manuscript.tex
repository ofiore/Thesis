...
seemed to be generally faster compared to the other datasets they considered, 
but they did not perform any formal %meaningful 
...
model the reaction time data. Additionally, we employ a signed-rank test for 
clustered data to 
...
%(the location of US World Championships 
...
%came from Johnson claiming there is a $(1/13)^3$ chance that the fastest 
%reaction times came during the same championships for the men's 100 meter,
...
year, so weather or climate related factors such as humidity, precipitation, elevation, may indeed play a role, but additionally, both the technology and 
...
%of World Athletics in terms of how they penalize false starts.  
From 2007--2009,
...
%broadcast.  
%\eds{I think we lost something here with all of the edits so I removed the 
%previous sentence. What was desirable for World Athletics -- the 2007-2009 rule
% change?  Why was this desirable?  The rule change would seem to make the event
% longer and not shorter? } 
There were 18 male and 7 female false starts at the 2007 World 
Championships, and 18 male and 7 female false starts at the 2009 World 
Championships. 
...
%World Championships there were 6 male disqualifications and 4 female 
...
%for the World Track and Field Championships a month later.  
...
the data were expanded to include reaction times for athletes who competed at 
...
second we can compare how athletes performed at the 2022 championships relative 
...
The %World Championships data and the data eyond the World Championships 
...
%\of{I believe that championships is correct, I have changed all instances of
%championship to championships}
...
% The link function $g$ can be the logarithm function to
...
%We include a random effect for venue (or year) because the technology
...
%\eds{I moved this info into the Data section.}
...
%% national level data or the previous world championships data and 2 corresponding
%% to the 2022 data.
