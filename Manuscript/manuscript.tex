...
Additionally, it was recommmended to IAAF that high speed cameras be used to
...
4)
This paper will try to model the data using a 
...
equipped to deal with high outliers.  
