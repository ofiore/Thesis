...
As shown in table~\ref{fig:Gamma_parameters}, the standard error of the year
...
the rank-based study~\ref{subsec:Results_Rank}.
  ...
  \begin{center}
    \begin{tabular}{c  c  c  c  c  c  c } 
     \toprule
     Dataset & Venue standard error & Int effect est & Int se & Int var & Resid Var \\ [0.5ex] 
     \midrule
...
finals as shown in table~\ref{fig:Sim_probability}.
