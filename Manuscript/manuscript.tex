...
the venue effect, $\alpha$ is the intercept, and $\phi$ is the dispersion
parameter of the gamma model.
...
\begin{table}
  \centering
  \caption{AIC and estimated parameters for the three GLMMs fitted to the ???
    data.}
