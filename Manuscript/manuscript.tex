...
of the heat effect is $\sigma_h^2$, the standard deviation of the venue effect
is $\sigma_v^2$, the intercept is $\alpha$ and we report $\sqrt{\phi}$ as the
standard deviation of the dispersion parameter $\phi$
\jy{read what you wrote. These are variances not sd. Do not start a sentence
  with a symbol (see my writing guidelines).}
\of{Resolved}
...
\jy{do a thorough check on the captions of tables and figures.}
...
\begin{table}
  ...
  \begin{tabular}{c c c c c c}
      \toprule
      Model & AIC & $\sigma_h^2$ & $\sigma_v^2$ & $\alpha$ & $\sqrt{\phi}$ \\
      \midrule
...
two thresholds: 0.1 and 0.08. 


\begin{table}
  \centering
  \caption{Probabilities of observing reaction times less than threshold 0.08, 0.09, and
  0.10 seconds based on the two effect model.}
...
\jy{discuss the differences between with/without 2022 data; comment on the
  pecularity of the 2022 data (as suggested by the rank based method); In a
  longer run, it may not be as strange as it looks at the first time.}
\of{Resolved}
...
\jy{be consistent in using scienfit format of numbers; 0.0001 vs $10^{-4}$}
\of{In our meeting you said to convert scientific notation like $10^{-2}$ to 
0.01, and I agree I think 0.01 makes much more sense. So should I convert
everything to decimals or scientific notation?}
