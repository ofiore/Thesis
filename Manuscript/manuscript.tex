...
Championships, or 2023 World Championships).  We excluded data from
200-meter dashes and longer events, as their RTs were found
to be significantly different. Negative RTs were excluded from the analysis,
while positive disqualified RTs were included due to their low frequency and not
...
meets.  Our findings are strengthened by having multiple comparisons: athletes
who competed in 2019 and 2022 got older over that timespan but we included an
analysis in which athletes would have been younger in 2022 and then older in
2023.  There are validly raised concerns that athletes who compete at their
national level competitions in 2022 may not react at their fastest due to a less
competitive environment or because they would try to peak for a more important
championship.  However, the athletes who competed in 2019 and 2023 are not
impacted by this factor, so its effect is minimzed to just one subset of a
broader analysis.
