...
```{r}
summary(gg3b)
cat("sigma_v or std dev of venue effect: ", gg3b$mu.coefSmo[[1]]$sigb, "\n")
cat("sigma_h or std dev of heat effect: ", gg3b$sigma.coefSmo[[1]]$sigb[1], "\n")
```

And now for the model excluding 2022
```{r}
summary(gg3b)
cat("sigma_v or std dev of venue effect: ", gg3b_no2022$mu.coefSmo[[1]]$sigb, "\n")
cat("sigma_h or std dev of heat effect: ", gg3b_no2022$sigma.coefSmo[[1]]$sigb[1], "\n")
```
