...
```{r}
men_old_finals_batch <-glmer(RxnTime ~ (1 | Batch), data = old_finals, 
                             family = Gamma(link = "log"))
men_finals_batch <-glmer(RxnTime ~ (1 | Batch), data = men_finals, 
                         family = Gamma(link = "log"))
men_old_pooled_batch <-glmer(RxnTime ~ (1 | Batch), data = old_pooled, 
                             family = Gamma(link = "log"))
men_pooled_batch <-glmer(RxnTime ~ (1 | Batch), data = men_pooled, 
                         family = Gamma(link = "log"))
```
```{}
...
```{r}
men_old_finals_two_effect <- glmer(RxnTime ~ (1 | Year) + (1 | Batch), 
                                   data = old_finals, family = Gamma(link = "log"))
men_finals_two_effect<- glmer(RxnTime ~ (1 | Year) + (1 | Batch), 
                              data = men_finals, family = Gamma(link = "log"))
men_old_pooled_two_effect <- glmer(RxnTime ~ (1 | Year) + (1 | Batch), 
                                   data = old_pooled, family = Gamma(link = "log"))
men_pooled_two_effect <- glmer(RxnTime ~ (1 | Year) + (1 | Batch), 
