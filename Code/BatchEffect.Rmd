...
```{}
The code chunk above creates 4 models: no random effects, a year effect only, 
batch effect only, and both year and batch effect.
```
...
```{}
This section fits a two random effect model for each dataset.
```
