...
```{r}
library(clusrank)
clusWilcox.test(Time, group=Year, cluster = Athlete, data = comp, paired = TRUE, alternative = "greater", method = "ds")
clusWilcox.test(Time, cluster = Athlete, data = comp, paired = TRUE, alternative = "greater", method = "rgl")
```
...
```{r}
library(clusrank)
clusWilcox.test(Time, group=Year, cluster = Athlete, data = nations, paired = TRUE, alternative = "greater", method = "ds")
