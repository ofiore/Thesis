...
colnames(comp) <- c("Time", "Group", "Cluster")
#View(comp)
```
...
clusWilcox.test(comp$Time, group=comp$Cluster, cluster = comp$Group, paired = TRUE, alternative = "greater", method = "rgl")
clusWilcox.test(comp$Time, cluster = comp$Group, paired = TRUE, alternative = "greater", method = "ds")
