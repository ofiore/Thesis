...
sim_two_effect_time(old_finals_two_effect, old_finals_one_gamma_log, 0.1)
sim_two_effect_time(men_finals_two_effect, men_finals_one_gamma_log, 0.1)
sim_two_effect_time(old_pooled_two_effect, old_pooled_one_gamma_log, 0.1)
sim_two_effect_time(men_pooled_two_effect, men_pooled_one_gamma_log, 0.1)
```
...
sprinters.
```{r}
sim_two_effect_prob(old_finals_two_effect, old_finals_one_gamma_log, 0.001)
sim_two_effect_prob(men_finals_two_effect, men_finals_one_gamma_log, 0.001)
sim_two_effect_prob(old_pooled_two_effect, old_pooled_one_gamma_log, 0.001)
sim_two_effect_prob(men_pooled_two_effect, men_pooled_one_gamma_log, 0.001)
```

The code below repeats the previous section but for an average of 1 in every
10,000 sprinters.
```{r}
sim_two_effect_prob(old_finals_two_effect, old_finals_one_gamma_log, 0.0001)
sim_two_effect_prob(men_finals_two_effect, men_finals_one_gamma_log, 0.0001)
sim_two_effect_prob(old_pooled_two_effect, old_pooled_one_gamma_log, 0.0001)
sim_two_effect_prob(men_pooled_two_effect, men_pooled_one_gamma_log, 0.0001)
```
...
```{r}
sim_one_effect_time(old_finals_year_gamma_log, old_finals_one_gamma_log, 0.1)
sim_one_effect_time(men_finals_year_gamma_log, men_finals_one_gamma_log, 0.1)
sim_one_effect_time(old_pooled_year_gamma_log, old_pooled_one_gamma_log, 0.1)
...
```{r}
sim_one_effect_prob(old_finals_year_gamma_log, old_finals_one_gamma_log, 0.001)
sim_one_effect_prob(men_finals_year_gamma_log, men_finals_one_gamma_log, 0.001)
sim_one_effect_prob(old_pooled_year_gamma_log, old_pooled_one_gamma_log, 0.001)
sim_one_effect_prob(men_pooled_year_gamma_log, men_pooled_one_gamma_log, 0.001)
```

```{r}
sim_one_effect_prob(old_finals_year_gamma_log, old_finals_one_gamma_log, 0.0001)
sim_one_effect_prob(men_finals_year_gamma_log, men_finals_one_gamma_log, 0.0001)
sim_one_effect_prob(old_pooled_year_gamma_log, old_pooled_one_gamma_log, 0.0001)
