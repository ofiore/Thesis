...
as a baseline to compare the venue effect models to in the simulation code below.
```{r}
#2
library(lme4)
...
#7
set.seed(1)
sim_two_effect_time(without2022_two_effect_gamma_log, without2022_one_gamma_log, 0.1)
sim_two_effect_time(with2022_two_effect_gamma_log, with2022_one_gamma_log, 0.1)
```

```{r}
set.seed(1)
sim_two_effect_time(without2022_two_effect_gamma_log, without2022_one_gamma_log, 0.09)
sim_two_effect_time(with2022_two_effect_gamma_log, with2022_one_gamma_log, 0.09)
```

```{r}
set.seed(1)
sim_two_effect_time(without2022_two_effect_gamma_log, without2022_one_gamma_log, 0.08)
sim_two_effect_time(with2022_two_effect_gamma_log, with2022_one_gamma_log, 0.08)
```
...
#9
set.seed(1)
sim_two_effect_prob(without2022_two_effect_gamma_log, without2022_one_gamma_log, 0.001)
sim_two_effect_prob(with2022_two_effect_gamma_log, with2022_one_gamma_log, 0.001)
```
...
#10
set.seed(1)
sim_two_effect_prob(without2022_two_effect_gamma_log, without2022_one_gamma_log, 0.0001)
sim_two_effect_prob(with2022_two_effect_gamma_log, with2022_one_gamma_log, 0.0001)
```
...
#12
set.seed(1)
sim_one_effect_time(without2022_venue_gamma_log, without2022_one_gamma_log, 0.1)
sim_one_effect_time(with2022_venue_gamma_log, with2022_one_gamma_log, 0.1)
```

```{r}
#13
set.seed(1)
sim_one_effect_time(without2022_heat_gamma_log, without2022_one_gamma_log, 0.1)
sim_one_effect_time(with2022_heat_gamma_log, with2022_one_gamma_log, 0.1)
```
...
```{r}
#15
sim_one_effect_prob(without2022_venue_gamma_log, without2022_one_gamma_log, 0.001)
sim_one_effect_prob(with2022_venue_gamma_log, with2022_one_gamma_log, 0.001)
```

```{r}
#16
sim_one_effect_prob(without2022_venue_gamma_log, without2022_one_gamma_log, 0.0001)
sim_one_effect_prob(with2022_venue_gamma_log, with2022_one_gamma_log, 0.0001)
```
