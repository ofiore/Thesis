...
```{r}
library(clusrank)
clusWilcox.test(Time, group=Year, cluster = Athlete, data = women_nations, paired = TRUE, alternative = "greater", method = "ds")
clusWilcox.test(Time, group=Year, cluster = Athlete, data = women_nations, paired = TRUE, alternative = "greater", method = "rgl")
```
