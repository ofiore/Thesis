...
clusWilcox.test(Time, group=Year, cluster = Athlete, data = nations, alternative = "greater", method = "ds", exact = TRUE)
```
...
clusWilcox.test(Time, group=Year, cluster = Athlete, data = comp, alternative = "greater", method = "ds", exact = TRUE)
```
